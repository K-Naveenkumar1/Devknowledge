...
import { Github, Folder, ExternalLink, ShieldCheck } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2 space-y-6">
                    ...
                    <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 flex flex-col items-center text-center">
                        ...
                        <h3 className="text-white font-semibold">No repositories connected</h3>
                        <p className="text-zinc-500 max-w-sm mt-1 mb-6">Connect your GitHub account to start syncing repository data and pull requests.</p>
                    </div>
                </div>
